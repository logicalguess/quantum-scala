...
# prepare state: cos(theta)|0> + i*sin(theta)|1>
...
if __name__ == "__main__":
    ...
    print("|theta| from prob of 1 = ", np.round(math.asin(math.sqrt(hist.get('1', 0))), 5))
    print("|theta| from prob of 0 = ", np.round(math.acos(math.sqrt(hist.get('0', 0))), 5))
